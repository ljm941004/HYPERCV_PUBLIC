...
/**
 * @brief      using K-MEANS method to cluster.
 * @param[in]  simple_mat  input mat.
 * @param[in]  POINT*      out put cluster point.
 * @param[in]  int         num of cluster kind.
 * @param[in]  int         threshold.
 **/
