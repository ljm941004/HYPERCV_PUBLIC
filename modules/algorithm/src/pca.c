...
*/
	delete_simple_mat(mean_mat);
	delete_simple_mat(cov_mat);
	delete_simple_mat(reshape_mat);
	delete_simple_mat(r_mat);
	delete_simple_mat(q_mat);
	delete_simple_mat(temp);
	delete_simple_mat(eigen_vector);
